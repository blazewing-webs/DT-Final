        ...
        <main className="min-h-screen font-sans bg-white">
            ...
            <header className="pt-32 pb-14 bg-neutral-900 text-white text-center relative overflow-hidden">
                ...
                <div className="relative z-10">
                    <span className="text-dravida-red text-xs font-bold uppercase tracking-[0.3em]">Editorial Note</span>
            ...
            <section className="py-20 bg-white">
                <div className="container mx-auto px-6 max-w-3xl space-y-10">
                    ...
                    <div className="flex items-center gap-4">
                        ...
                        <span className="text-neutral-400 text-xs uppercase tracking-widest font-bold">English</span>
                        <div className="flex-1 h-px bg-neutral-200" />
                    </div>
